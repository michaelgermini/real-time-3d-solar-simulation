...
// Professional Shader class
class ProfessionalShader {
public:
    ProfessionalShader() : program(0) {}
...
// Professional Solar Panel class
class ProfessionalSolarPanel {
public:
    ...
    ProfessionalSolarPanel(PanelType type, const glm::vec3& pos, const glm::vec2& sz) 
    ...
    void Render(const glm::mat4& viewProjection, const ProfessionalShader& shader) {
        shader.Use();
...
// Global variables
GLFWwindow* window;
std::vector<std::unique_ptr<ProfessionalSolarPanel>> solarPanels;
std::unique_ptr<ProfessionalCamera> camera;
std::unique_ptr<ProfessionalShader> mainShader;
...
int main() {
    std::cout << "Professional 3D Solar Panel Simulation with OpenGL" << std::endl;
    std::cout << "==================================================" << std::endl;
    ...
    // Create window
    window = glfwCreateWindow(1200, 800, "Professional Solar Panel 3D Simulation", nullptr, nullptr);
    if (!window) {
    ...
    // Create shader
    mainShader = std::make_unique<ProfessionalShader>();
    ...
    for (int i = 0; i < 10; i++) {
        for (int j = 0; j < 10; j++) {
            ...
            solarPanels.push_back(std::make_unique<ProfessionalSolarPanel>(
                ProfessionalSolarPanel::PanelType::MONOCRYSTALLINE, 
                position, 
                glm::vec2(1.5f, 1.0f)
            ));
        }
    ...
    std::cout << "Professional Solar Panel Simulation Running!" << std::endl;
    ...
    glfwTerminate();
    std::cout << std::endl << "Professional simulation ended successfully!" << std::endl;
    return 0;
}
